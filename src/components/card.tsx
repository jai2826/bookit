...
const Card = (experience: Experience) => {
  ...
  return (
    <div className="w-full sm:w-[calc(50%-12px)] lg:w-[280px] h-[312px] rounded-[12px] overflow-hidden">
      ...
      <div className="py-3 px-4 bg-[#F0F0F0] flex flex-col gap-y-5">
        ...
        <div className="flex justify-between">
          ...
          <button
            ...
            className="bg-[#FFD643] gap-[10px] py-1.5 px-2 text-center rounded-[4px] font-medium text-[14px] leading-[18px] cursor-pointer"
          >
            View Details
          </button>
        </div>
